...
/* Handles calculations and rendering of a multiple series Histogram.
   Places the bins on top of each other in percentages and scales them to
...
var Histogram100StackedSeries = React.createClass({
  ...
  render: function() {
    ...
    var xScale = d3.scaleLinear()
      ...
      .range([props.padding, props.width - (2.5*props.padding)]);
    ...
    binnedData.map(function(bin, j) {
      ...
      bars[j] = bin.map(function(value, i) {
        ...
        // Calculates the percentage of the bar for it's group and maps that
        // percentage to a height
    ...
    var legendTransform = `translate(${props.width-props.padding*2}, ${props.padding/2})`;
